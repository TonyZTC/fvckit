...
from fvckit import PARAM_TYPE
from fvckit.frontend.features import mfcc, plp
from fvckit.frontend.io import read_audio, read_label, write_hdf5
from fvckit.frontend.vad import vad_snr, vad_energy, vad_percentil
from fvckit.fvckit_wrappers import process_parallel_lists
...
class FeaturesExtractor(object):
    ...
    def save_multispeakers(self,
        ...
        for show in tmp_dict:
            ...
            for _id in tmp_dict[show]:
                ...
                idx = idx[idx < l]
                _, threshold_id = self._vad(None, energy[idx], None, None, os.path.splitext(input_audio_filename)[0] + '.vad')
    ...
    def _vad(self, cep, log_energy, fb, x, label_file_name=None):
        ...
        if self.vad is None:
            ...
            label = read_label(label_file_name, 'speech', 100, log_energy.shape[0])
        else:
